...
public class Command {
    ...
    private void loadProfile() {
        ...
        try {
            if (profileDirectory == null) {
                // Load the profiles from the jar file
    ...
    public static void usage() {
        ...
        System.out.println("  --genprofile -d [abstracts directory] [language names]");
        System.out.println("  --genprofile-text -l [language code] [text file path]");
        System.out.println("  --detectlang [-d profile directory] -a [alpha] -s [seed] [test file(s)]");
        System.out.println("  --batchtest [-d profile directory] -a [alpha] -s [seed] [test data(s)]");
    }
